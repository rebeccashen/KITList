...
<div class="wrap">
	...
	<h2><?php _e('WooCommerce Views','woocommerce_views');?></h2>
		...
		method="post">
			...
			?>		
			<p class="submit">
			<input id="woocommerce_views_submit" form="woocommerce_views_form"
				type="submit" name="Submit" class="button-primary"
				value="<?php _e('Save all Settings','woocommerce_views');?>" />
		</p>
...
<?php 
	...
	public function wc_views_prefix_add_wrapper( $content, $template_selected, $id, $kind ) {
	    ...
	    if (isset($views_settings_options['views_template_for_product'])) {
	    	...
	    	if (( $kind == 'single-product' ) && ($template_selected==$product_template_id)) {
	    		global $post_classes_wc_added;
