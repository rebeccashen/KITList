...
// current version
define('CRED_COMMERCE_VERSION','0.9.5');
...
require_once CRED_COMMERCE_PLUGIN_PATH. '/onthego-resources/onthegosystems-branding-loader.php';
ont_set_on_the_go_systems_uri_and_start( CRED_COMMERCE_PLUGIN_URL . '/onthego-resources/' );
