...
<div class="wrap">
    <h2><?php _e('CRED Forms', 'wp-cred'); ?><a class="add-new-h2 js-open-promotional-message" href="<?php echo CRED_CRED::$help['add_forms_to_site']['link']; ?>"><?php _e('Add New', 'wp-cred'); ?></a>
