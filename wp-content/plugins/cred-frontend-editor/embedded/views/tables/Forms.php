...
class CRED_Forms_List_Table extends WP_List_Table implements CRED_Singleton
{
    ...
    */  
	...
	function bulk_actions( $args = array() ) 
    {
        ...
        echo "<a style='margin-left:15px' class='button button-large cred-export-all' href='".CRED_CRED::route('/Forms/exportAll?all&_wpnonce='.wp_create_nonce('cred-export-all'))."' target='_blank' title='".esc_js(__('Export All Forms','wp-cred'))."'>".__('Export All Forms','wp-cred')."</a>";
	}
