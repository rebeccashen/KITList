...
//        );
        ...
        CRED_Helper::$screens = array('toplevel_page_CRED_Forms', 'cred_page_CRED_Forms', 'cred_page_CRED_Fields');
...
//    }
    ...
    public static function onAdminEnqueueScripts() {
        ...
        wp_register_style('utility-style', CRED_PLUGIN_URL . '/icl-common/utility/css/notifications.css', array(), time());
    ...
    public static function getAdminPage($custom_data = array()) {
        ...
        CRED_Helper::$currentPage = $pageData;
        return $pageData;
    }
    ...
    public static function jsForCredCustomPost() {
        ...
        elseif (self::$currentPage->isPostEdit || self::$currentPage->isPostNew || $screen->id == 'views-new_page_views-editor' || $screen->id == 'views-new_page_view-archives-editor') {
            ?>
            <script type='text/javascript'>
                /*<![CDATA[ */
                jQuery(function () {
