	...
	<div class="wpv-setting-container wpv-settings-output-extra-js js-wpv-settings-layout-settings-extra-js<?php echo $hide; ?>">
		...
		<div class="wpv-setting">
			<p>
				...
				<input type="text" id="wpv-layout-settings-extra-js" autocomplete="off" class="js-wpv-layout-settings-extra-js" name="_wpv_layout_settings[additional_js]" value="<?php echo $js; ?>" style="width:100%;" />
			</p>
