...
function add_view_filter_extra( $view_settings, $view_id ) {
	...
	<div class="wpv-setting-container wpv-setting-container-horizontal wpv-settings-filter-markup js-wpv-settings-filter-extra js-wpv-filter-extra-section <?php echo $hidden_class; ?>">
		...
		?>
		<div class="toolset-help js-wpv-missing-filter-container<?php echo $listing == 'posts' ? '' : ' hidden'; ?>">
		...
		?>
		<div class="toolset-help js-wpv-missing-filter-container hidden"></div>
		<?php
		}
		...
		$controls_count = $controls_per_kind['cf'] + $controls_per_kind['tax'] + $controls_per_kind['pr'] + $controls_per_kind['search'];
		?>
		<div class="toolset-alert js-wpv-no-filters-container<?php if ( $listing == 'posts' && $purpose == 'parametric' ) { if ( $controls_count != 0 ) { echo ' hidden'; } } else { echo ' hidden'; } ?>">
			<p>
		...
		<div class="wpv-setting">
			...
			<!-- <div class="js-error-container"></div> --><!-- This is being added dinamically on the parametric script!!! -->
		...
		<div class="wpv-dialog wpv-dialog-parametric-filter wpv-dialog-spinner-button js-spinner-button-dialog"> <!-- Popup for the spinner button addition -->
			...
			<div class="js-spinner_shortcode_label-wrap wpv-dialog-content">
				...
				<p>
					...
					foreach ( $available_spinners as $av_spinner ) {
						...
						<li style="min-width:49%;float:left;">
							<label>
								<input type="radio" class="js-wpv-ps-spinner-image" name="wpv-dps-spinner-image" value="<?php echo $av_spinner['url']; ?>" <?php if ( ! $has_spinner_image_checked ) { echo ' checked="checked"'; } ?> />
								<img src="<?php echo $av_spinner['url']; ?>" title="<?php echo esc_attr( $av_spinner['title'] ); ?>" />
							</label>
						</li>
						<?php 
				...
				<p>
					...
					<span class="wpv-helper-text"><?php _e( 'This will be shown nside the container and along with the spinner', 'wpv-views' ); ?></span>
				</p>
			</div>
