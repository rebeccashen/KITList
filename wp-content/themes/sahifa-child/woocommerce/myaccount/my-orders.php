 ...
 * My Orders
 *
 * Shows recent orders on the account page -- overwritten by Rebecca Shen
 *
 * @author 		WooThemes
	...
	<table class="shop_table shop_table_responsive my_account_orders">
		...
		<thead>
			<tr>
				...
				<th class="order-available"><span class=" "nobr"><?php _e('Posts Available', 'woocommerce'); ?></span></th>
		...
		<tbody><?php
			foreach ( $customer_orders as $customer_order ) {
				...
				?><tr class="order">
					...
					<td class="order-available" data-title="<?php _e( 'Posts Available', 'woocommerce' ); ?>">
						<?php echo sprintf( _n( '%s for %s item', '%s for %s items', $item_count, 'woocommerce' ), $order->get_post_custom([1],0), $item_count ); ?>
					</td>
