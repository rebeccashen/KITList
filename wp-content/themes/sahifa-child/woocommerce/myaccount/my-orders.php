...
/** customized for output to be different and displays # of posts available and # of posts used.
 * Rebecca Shen for KIT List 20150604
 **/
...
$customer_orders = kit_get_customer_orders();
...
<!--Begin Customization -->
<!--                <th class="order-posts"><span class="nobr">--><?php //_e( 'Posts Available', 'woocommerce' ); ?><!--</span></th>-->
<!--End Customization -->
...
//<!--Begin Customization -->
                      //echo sprintf( _n( '%s for %s item', '%s for %s items', $item_count, 'woocommerce' ), $order->get_formatted_order_total(), $item_count );
                        ...
                        echo sprintf( _n( '%s for %s item for %s posts', '%s for %s items for %s posts', $item_count, $post_count, 'woocommerce' ), $order->get_formatted_order_total(), $item_count, $post_count );
