 ...
 * RYS
 *
 *Customizing for KIT to override some of the formats
 */
...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
    ...
    <form name="registerform" id="registerform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'register' ); ?>" method="post">
        ...
        <p>
            ...
            <input type="text" name="first_name" id="first_name<?php $template->the_instance(); ?>" class="input" value="<?php $template->the_posted_value( 'first_name' ); ?>" size="30" />
        </p>

        <p>
            <label for="types_usermeta_user_role<?php $template->the_instance(); ?>"><?php _e( 'Role', 'theme-my-login' ); ?></label>
            <input type="text" name="user_role" id="user_role<?php $template->the_instance(); ?>" class="input" value="<?php $template->the_posted_value( 'user_role' ); ?>" size="30" />
        </p>

        <p>Good Day Man!  You are kit-newsubscriber.php</p>
